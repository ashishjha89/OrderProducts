...
class ProductServiceApplicationTests {
        ...
        void postApiCall_ShouldThrowBadRequestException_WhenNameOrDescriptionOrPriceIsEmptyOrMissing()
                        throws Exception {
                // Initialise 1
                ...
                // Initialise 2
                var productRequestWithNameAsNull = ProductRequest.builder().name(null).price(BigDecimal.valueOf(100))
                ...
                // Initialise 3
                var productRequestWithDescriptionAsNull = ProductRequest.builder().name("name")
                                .price(BigDecimal.valueOf(100)).description(null).build();
                ...
                // Initialise 4
                var productRequestWithPriceAsNull = ProductRequest.builder().name("name").price(null)
                                .description("Description").build();
